...
# END Problem EC
    ...
    def __init__(self, armor=1):
        ...
        self.TrueQueen = QueenAnt.QueenSet
        if QueenAnt.QueenSet:
            self.doubled = [True]
            QueenAnt.QueenSet = False
        # END Problem EC
    ...
    def action(self, gamestate):
        ...
        if self.TrueQueen is False:
            ...
            cur = 1
            while cur_place != None:
                if cur_place.ant is not None and not self.doubled[cur]:
                    self.doubled[cur] = True
...
class Bee(Insect):
    ...
    def action(self, gamestate):
        ...
        if self.direction == 'RIGHT':
            ...
            if destination == isinstance(destination, Hive):
...
class ScaryThrower(ThrowerAnt):
    ...
    def throw_at(self, target):
        # BEGIN Problem Optional 4
        "*** YOUR CODE HERE ***"
        if not target.scared and target:
...
class LaserAnt(ThrowerAnt):
    ...
    def calculate_damage(self, distance):
        # BEGIN Problem Optional 5
        damage_fact = self.damage - 0.2 * distance - 0.05 * self.insects_shot
        return damage_fact if damage_fact > 0 else 0 
        # END Problem Optional 5
